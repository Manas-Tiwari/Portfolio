    ...
    <div>
      ...
      >
        <div className="hero-text py-2 px-4 mb-5">
          <h1 className="text-4xl text-zinc-100 tracking-tight font-bold sm:text-5xl md:text-6xl">
          ...
          <span className="mt-6 mr-16 pt-4 text-zinc-500 block font-poppins text-[30px]">
